...
SG_12_patch = SG_12_patch %>%
  mutate(habitat = c("sand", "seagrass"), site= "SG_12")
...
SG_14_patch = SG_14_patch %>%
  mutate(habitat = c("seagrass", "sand"), site= "SG_14")
...
SG_17_patch = SG_17_patch %>%
  mutate(habitat = c("sand", "seagrass"), site= "SG_17")
